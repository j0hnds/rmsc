...
#    options
    ...
    label = "#{field_name.to_s.humanize}: <em>#{image_tag "required-star.png", :alt => "required"}</em>" if target.class.validators_on(field_name).map(&:class).include? ActiveModel::Validations::PresenceValidator
